 ...
 * Exaple
 *
 * Calculation of a cube of Double number
 */
...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    ...
    var lenghtInVershoks = sagenes.toDouble() * 48 + arshins.toDouble() * 16 + vershoks.toDouble()
    return lenghtInVershoks * 4.445 / 100
}
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val arriveTimeInMinutse = hoursArrive * 60 + minutesArrive
    val departTimeInMinutes = hoursDepart * 60 + minutesDepart
    return arriveTimeInMinutse - departTimeInMinutes
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial.toDouble() * cube(1 + percent.toDouble() / 100)
